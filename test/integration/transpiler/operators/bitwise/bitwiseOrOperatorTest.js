...
describe('Transpiler bitwise OR operator "|" test', function () {
    ...
    it('should correctly transpile a return with an operation between a variable and complex expression', function () {
        ...
        expect(phpToJS.transpile(ast, {bare: true})).to.equal(
            'function (core) {' +
            'var bitwiseOr = core.bitwiseOr, createString = core.createString, getVariable = core.getVariable, snapshot = core.snapshot, ternary = core.ternary;' +
            'return bitwiseOr(' +
