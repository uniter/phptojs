...
describe('Transpiler less-than-or-equal comparison operator test', function () {
    ...
    it('should correctly transpile a return with a comparison between a variable and complex expression', function () {
        ...
        expect(phpToJS.transpile(ast, {bare: true})).to.equal(
            'function (core) {' +
            'var createString = core.createString, getVariable = core.getVariable, isLessThanOrEqual = core.isLessThanOrEqual, snapshot = core.snapshot, ternary = core.ternary;' +
