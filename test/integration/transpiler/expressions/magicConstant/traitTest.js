...
describe('Transpiler __TRAIT__ magic constant test', function () {
    it('should correctly transpile a return statement outside of class', function () {
        ...
        expect(phpToJS.transpile(ast, {bare: true})).to.equal(
            'function (core) {' +
            'var getTraitName = core.getTraitName;' +
            'return getTraitName();' +
            '}'
        );
    });
    ...
    it('should correctly transpile a return statement inside class method', function () {
        ...
        expect(phpToJS.transpile(ast, {bare: true})).to.equal(
            'function (core) {' +
            'var defineClass = core.defineClass, getTraitName = core.getTraitName;' +
