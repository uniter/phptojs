...
describe('Transpiler closure expression return-by-reference test', function () {
    it('should correctly transpile a return of a closure with parameters and bound variables that returns by reference', function () {
        var ast = {
            name: 'N_PROGRAM',
            statements: [{
